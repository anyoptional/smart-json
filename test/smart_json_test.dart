...
[
  ...
  "source":"Raffi Krikorian's source",
  "user":{
...
""";
  ...
  test("init", () {
    final json0 = JSON.parse(jsonString);
    expect(json0.array.length, 3);
    expect(JSON.from("123").toString(), "123");
    expect(JSON.from({"1" : "2"})["1"].string, "2");
  });
